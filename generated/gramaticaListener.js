...
export default class gramaticaListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by gramaticaParser#bucle.
	enterBucle(ctx) {
	}

	// Exit a parse tree produced by gramaticaParser#bucle.
	exitBucle(ctx) {
	}
	...
	// Enter a parse tree produced by gramaticaParser#salida.
	enterSalida(ctx) {
	}

	// Exit a parse tree produced by gramaticaParser#salida.
	exitSalida(ctx) {
	}


	// Enter a parse tree produced by gramaticaParser#terminar.
	enterTerminar(ctx) {
	}

	// Exit a parse tree produced by gramaticaParser#terminar.
	exitTerminar(ctx) {
	}
